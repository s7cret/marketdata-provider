...
_BINANCE = {"1s":"1s","1":"1m","1m":"1m","3":"3m","3m":"3m","5":"5m","5m":"5m","15":"15m","15m":"15m","30":"30m","30m":"30m","60":"1h","60m":"1h","1h":"1h","120":"2h","120m":"2h","2h":"2h","240":"4h","240m":"4h","4h":"4h","360":"6h","360m":"6h","6h":"6h","720":"12h","720m":"12h","12h":"12h","D":"1d","1D":"1d","1d":"1d","W":"1w","1W":"1w","1w":"1w","M":"1M","1M":"1M"}
_BYBIT = {"1":"1","1m":"1","3":"3","3m":"3","5":"5","5m":"5","15":"15","15m":"15","30":"30","30m":"30","60":"60","1h":"60","120":"120","2h":"120","240":"240","4h":"240","360":"360","6h":"360","720":"720","12h":"720","D":"D","1D":"D","1d":"D","W":"W","1W":"W","1w":"W","M":"M","1M":"M"}

def canonical_timeframe(tf: str) -> str:
    raw = tf.strip()
    if raw in {"D","1D","1d"}: return "1D"
    if raw in {"W","1W","1w"}: return "1W"
    if raw in {"M","1M"}: return "1M"
    if raw.isdigit(): return f"{int(raw)}m"
    m = re.fullmatch(r"(\d+)([smhd])", raw, re.I)
    if not m: raise MDTimeframeUnsupported(f"Unsupported timeframe: {tf}")
...
def timeframe_ms(tf: str) -> int:
    ...
    if c == "1D": return 86_400_000
    if c == "1W": return 7 * 86_400_000
    if c == "1M": raise MDTimeframeUnsupported("1M has variable length; use close_time_ms")
...
def close_time_ms(open_time_ms: int, tf: str) -> int:
    ...
    d = _dt(open_time_ms)
    if c == "1D":
        return _ms(datetime(d.year, d.month, d.day, tzinfo=timezone.utc)) + 86_400_000 - 1
    if c == "1W":
    ...
    if c == "1M":
        ...
        return _ms(datetime(d.year, d.month, last, tzinfo=timezone.utc)) + 86_400_000 - 1
