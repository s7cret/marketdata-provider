...
def test_validation_duplicate_rejected():
    rows = [[1000,"1","2","0.5","1.5","10",60999],[1000,"1","2","0.5","1.5","10",60999]]
    with pytest.raises(MDValidationError): normalize_binance_klines(rows, symbol="BTCUSDT", market="spot", timeframe="1m")
