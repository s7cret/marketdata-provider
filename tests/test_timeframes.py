...
from marketdata_provider.timeframes import close_time_ms, next_open_time_ms, timeframe_ms, to_binance_interval, to_bybit_interval

def ms(y,m,d,h=0,mi=0): return int(datetime(y,m,d,h,mi,tzinfo=timezone.utc).timestamp()*1000)
